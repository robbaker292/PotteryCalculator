...
<div id="editing">
	...
	<form id="basicForm">
		...
		<div class="form-group">
			<div class="btn-group" role="group" aria-label="...">
				<button type="button" class="btn btn-primary" id="saveBasic">Save product</button>
			</div>
			<div id="saveResult">
				<?php
	...
	<h3>Resource Data:</h3>
		<form id="resourceForm">
			...
			<button type="button" class="btn btn-success" id="resourceAdder">Add another resource</button>&nbsp;
			<button type="button" class="btn btn-primary" id="saveResources">Save this section</button>
			<div id="saveResultResource">
				<?php
					if($this->session->flashdata('area') == "resource") {
						$type = $this->session->flashdata('type');
						$message = $this->session->flashdata('message');
						if($type == "success") {
							?>
